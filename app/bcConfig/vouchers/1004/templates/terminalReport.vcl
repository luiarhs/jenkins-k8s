...
text "------------------------------------";
newline;
  text "* $terminalReportData.reportTerminalType *  #formatFecha($date) $time";
newline;
...
text "#fmt("%-28.28s %6.6s", ["NUMERO DE BOLETA EN NVRAM:","$terminalReportData.nvramTrxNumber"])";
text "#fmt("%-28.28s %6.6s", ["NUMERO DE BOLETA EN EALTERMS:","$terminalReportData.ealTrxNumber"])";